...
HINWEIS: Benötigt strukturierte Earnings-Daten mit EPS-Surprise.
yfinance liefert diese nicht zuverlässig. Für vollständige Nutzung wird
die Financial Datasets API (https://financialdatasets.ai) empfohlen.
