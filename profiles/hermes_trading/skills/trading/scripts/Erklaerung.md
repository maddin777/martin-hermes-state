...
13. **Weekly Trend Filter:** Weekly EMA20 = Trendrichtung. BEARISH → keine LONGs. BULLISH → keine SHORTs. ("Don't fight the tape")
14. **Correlation-Filter:** Kein Entry wenn Pearson-Korrelation > 0.70 mit einer offenen Position gleicher Richtung (60-Tage-Renditen, gecached 30min)
```
