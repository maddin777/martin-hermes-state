...
description: "Drive the macOS desktop in the background (screenshots, mouse, keyboard, scroll, drag) without stealing cursor/focus/Space. macOS-specific supplement to the cross-platform computer-use skill; load this when the host is macOS."
version: 1.0.0
platforms: [macos]
metadata:
  hermes:
